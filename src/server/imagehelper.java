...
public class imagehelper {
    public static Image resize(Image ogirinalImage , int targetWidth,int targetHeight){
        Image resultingImage = ogirinalImage.getScaledInstance(targetWidth, targetHeight,Image.SCALE_SMOOTH);
